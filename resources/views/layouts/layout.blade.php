...
<h2>Less #31. Создание панели администрирования. (AdminLTE )</h2>
<p>Сайт: <a href="https://github.com/jeroennoten/laravel-adminlte" target="_blank">AdminLTE</a></p>
<hr>
    <!-- ##### Preloader ##### -->
                    ...
                    <div class="col-12">
                        <div class="top-header-content d-flex align-items-center justify-content-between">
                            ...
                            <div class="top-social-info">
                                ...
                                <a href="{{route('admin.blog')}}">Login</a>
                            </div>
                        </div>
                    </div>
                </div>
